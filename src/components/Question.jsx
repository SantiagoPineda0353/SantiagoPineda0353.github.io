...
function Question() {
  ...
  const trends = ['Qué tipo de Pokemon es Tylercito?', 'Por qué Luisa no se baña?', `Almas Gemelas King Kong Click Letra`,]

  const handleSearch = (e) => {
    e.preventDefault()
    if (searchQuery.toLowerCase() === 'cuanto tiempo llevamos juntos santiago y yo?' || searchQuery.toLowerCase() === 'cuanto tiempo llevamos juntos santiago y yo' || searchQuery.toLowerCase() === 'cuanto tiempo llevamos juntos Santiago y yo?' ) {
          navigate("/timer");
       ...
       <div
        ...
        >
          ...
          <div className="mt-8 w-full max-w-[600px]">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl">Más buscado</h2>
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p>Intenta buscar "Cuanto tiempo llevamos juntos Santiago y yo?" ;D</p>
          </div>
        </div>
      )}
    </div>
