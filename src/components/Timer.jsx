...
function Timer() {
  // Anniversary date
  const START_DATE = new Date('2024-05-26')
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      const days = Math.abs(differenceInDays(now, START_DATE))-1
...
>
  <div className="text-center z-10">
    ...
    <p className=' text-lg mb-8 drop-shadow-lg'>{`... y sigo contando Amorsura 🤍` }</p>
    {/* Button */}
